        ...
        <Layout >
            <ReactLenis ref={lenisRef}>
                ...
                <LazyMotion features={domAnimation}>
                    ...
                    >
                        <Div100vh>
                            <m.div variants={fade} className="bg-off-white h-full text-light-brown selection:bg-light-brown selection:text-light-brown h-full relative flex flex-wrap">
                                ...
                                <m.main variants={fade} className="h-full p-4 md:p-6 relative w-full relative bg-off-white" >

                                    <article className="flex flex-wrap w-full justify-center h-[97%]">
                                        ...
                                        <LazyMotion features={domAnimation}>
                                            <m.div variants={fade} className="w-full font-serif text-xl xl:text-[22px] leading-tight tracking-tight content flex flex-col justify-center">
                                                ...
                                                <m.div variants={fadeLate} className="h-full">
                                                    <div className="w-full h-[12%] relative z-10 flex items-center">
                                    ...
                                    <m.footer variants={fadeLate} className="h-[3%] bg-off-white relative w-full flex items-end">
