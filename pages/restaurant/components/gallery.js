                    ...
                    >
                        <Div100vh className='w-full bg-off-white'>
                            <m.div variants={fade} className="h-full bg-off-white text-light-brown selection:bg-off-white selection:text-light-brown flex flex-wrap ">
                                ...
                                <m.main variants={fade} className="pb-0 p-4 md:p-6 relative w-full relative bg-off-white h-[90%] flex items-center justify-center flex-col" >
                                    <div className="w-full relative z-10 mb-5  flex justify-center pt-0 lg:pt-6">
                                        <a className="block w-[20rem] flex justify-center">
