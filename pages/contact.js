                      ...
                      <div className="w-full md:w-11/12 xl:w-10/12 mx-auto overflow-hidden">
                        <div className="flex flex-wrap">
                          <div className="w-full md:w-1/2 mb-12 md:mb-0 md:pr-12 xl:pr-24">
                            ...
                            <div><a href="https://www.tripadvisor.es/Restaurant_Review-g187438-d13200317-Reviews-Pampa_Grill_Malaga-Malaga_Costa_del_Sol_Province_of_Malaga_Andalucia.html" target="_blank" rel="noopener noreferrer" className="group inline-block font-serif mb-3 text-black relative text-xl md:text-2xl font-normal leading-[1.15] md:leading-[1.2] tracking-tight mr-8 transition-colors ease-in-out duration-500 overflow-hidden">
